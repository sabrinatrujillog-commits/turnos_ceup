...
<head>
  ...
  <style>
    ...
    *{ box-sizing:border-box; }
    ...
    .card.t-red{ border-color:var(--amarillo); border-top-color:var(--amarillo); background:#fffce8; }
    .card.t-org{ border-color:var(--amarillo); border-top-color:var(--amarillo); background:#fffce8; }

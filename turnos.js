...
<head>
  ...
  <style>
    ...
    *{ box-sizing:border-box; }
    ...
    .card.t-red{ border-color:var(--naranja); border-top-color:var(--naranja); background:#fdf0e6; }
    .card.t-org{ border-color:var(--naranja); border-top-color:var(--naranja); background:#fdf0e6; }

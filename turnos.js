...
<head>
  ...
  <style>
    ...
    *{ box-sizing:border-box; }
    ...
    .bar{ display:flex; gap:10px; align-items:center; padding:12px 18px; background:rgba(8,20,50,0.85); backdrop-filter:blur(12px); -webkit-backdrop-filter:blur(12px); box-shadow:0 2px 12px rgba(15,45,107,0.15); border-bottom:none; flex-wrap:wrap; }

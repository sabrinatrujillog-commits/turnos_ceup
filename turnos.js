...
<head>
  ...
  <style>
    ...
    *{ box-sizing:border-box; }
    ...
    .card.t-yel{ border-color:var(--amarillo); border-top-color:var(--amarillo); background:#fff; }
    .card.t-yel h3{ color:var(--amarillo); }
    .card.t-grn{ border-color:var(--verde); border-top-color:var(--verde); background:#fff; }
    .card.t-grn h3{ color:var(--verde); }
    .card.t-red{ border-color:var(--amarillo); border-top-color:var(--amarillo); background:#fff; }
    .card.t-red h3{ color:var(--amarillo); }
    .card.t-org{ border-color:var(--amarillo); border-top-color:var(--amarillo); background:#fff; }
    .card.t-org h3{ color:var(--amarillo); }
